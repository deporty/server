...
class FileRepository extends infrastructure_1.FileAdapter {
    constructor(storage) {
        super();
    ...
    getAbsoluteHTTPUrl(filePath) {
        return filePath
            ? (0, rxjs_1.from)(this.storage.bucket().file(filePath).getMetadata()).pipe((0, operators_1.catchError)((error) => {
