...
def kube(server_config, logger):

  command = f"gcloud container clusters get-credentials autopilot-cluster-1 --region southamerica-east1 --project deporty-dev"
  print(command)
...
def get_ingress_template(servers_config):
