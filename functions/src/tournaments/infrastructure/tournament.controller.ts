...
export class TournamentController extends BaseController {
  ...
  static registerEntryPoints(app: Express, container: Container) {
    ...
    const validator = (resourceName: string) =>
      authorizedUserMiddleware.getValidator(resourceName, JWT_SECRET);
    ...
    app.put(`/match-sheet`, (request: Request, response: Response) => {
      ...
      this.handlerController<CreateMatchSheetUsecase, any>(
        container,
    ...
    app.post(
      ...
      (request: Request, response: Response) => {
        ...
        this.handlerController<AddIntergroupMatchUsecase, any>(
          container,
          "AddIntergroupMatchUsecase",
          response,
          config,
          undefined,
          params
    ...
    app.get(
      ...
      (request: Request, response: Response) => {
        ...
        this.handlerController<GetIntergroupMatchesUsecase, any>(
          container,
          "GetIntergroupMatchesUsecase",
          response,
          config,
          undefined,
          { ...params, states: request.query.states }
        );
      }
    );
    app.delete(
    ...
    app.patch(
      ...
      (request: Request, response: Response) => {
        ...
        this.handlerController<EditIntergroupMatchUsecase, any>(
          container,
          "EditIntergroupMatchUsecase",
          response,
          config,
          undefined,
          {
            ...
            intergroupMatch: {
              ...
              match: {
                ...request.body.match,
                date: request.body.match.date
                  ? getDateFromSeconds(request.body.match.date)
                  : undefined,
              },
            },
          }
    ...
    app.get(
      `/by-position`,
      validator("GetTournamentsByRatioUsecase"),
      (request: Request, response: Response) => {
        const params = request.query;
        ...
        this.handlerController<GetTournamentsByRatioUsecase, any>(
          container,
          "GetTournamentsByRatioUsecase",
          response,
          config,
          undefined,
          {
    ...
    app.put(
      `/:id/cost`,
      validator("CalculateTournamentCostByIdUsecase"),
      (request: Request, response: Response) => {
        const id = request.params.id;
    ...
    app.put(
      `/add-team`,
      validator("AddTeamsToTournamentUsecase"),
      (request: Request, response: Response) => {
        const params = request.body;
    ...
    app.get(
      ...
      validator("GetPosibleTeamsToAddUsecase"),
      (request: Request, response: Response) => {
    ...
    app.get(
      `/`,
      validator("GetTournamentsUsecase"),
      (request: Request, response: Response) => {
        const params = request.query;
        const config: IMessagesConfiguration = {
          exceptions: {},
    ...
    app.get(`/current-tournaments`, (request: Request, response: Response) => {
      ...
      this.handlerController<GetCurrentTournamentsUsecase, any>(
        container,
        "GetCurrentTournamentsUsecase",
        response,
        config,
        undefined
      );
    ...
    app.get(
      ...
      (request: Request, response: Response) => {
        ...
        this.handlerController<GetAllMatchesByDateUsecase, any>(
          container,
          "GetAllMatchesByDateUsecase",
          response,
          config,
          undefined,
          date
    ...
    app.get(
      `/by-organization-and-tournament-layout`,
      (request: Request, response: Response) => {
    ...
    app.delete(
      `/:tournamentLayoutId`,
      validator("DeleteTournamentUsecase"),
      (request: Request, response: Response) => {
        ...
        this.handlerController<DeleteTournamentUsecase, any>(
          container,
    ...
    app.post(
      `/:id/fixture-stage`,
      validator("CreateFixtureStageUsecase"),
      (request: Request, response: Response) => {
        ...
        this.handlerController<CreateFixtureStageUsecase, any>(
          container,
          "CreateFixtureStageUsecase",
          response,
          config,
          undefined,
          body
    ...
    app.get(
      `/:tournamentId/fixture-stage/:fixtureStageId/groups`,
      (request: Request, response: Response) => {
        const params = request.params;
    ...
    app.delete(
      ...
      (request: Request, response: Response) => {
        ...
        this.handlerController<DeleteGroupByIdUsecase, any>(
          container,
    ...
    app.delete(
      ...
      (request: Request, response: Response) => {
        ...
        this.handlerController<DeleteTeamsInGroupUsecase, any>(
          container,
          "DeleteTeamsInGroupUsecase",
          response,
          config,
          undefined,
          params
    ...
    app.post(
      ...
      (request: Request, response: Response) => {
        ...
        this.handlerController<SaveGroupUsecase, any>(
          container,
          "SaveGroupUsecase",
          response,
          config,
    ...
    app.get(
      ...
      (request: Request, response: Response) => {
        ...
        this.handlerController<GetGroupByIdUsecase, any>(
          container,
          "GetGroupByIdUsecase",
          response,
          config,
    ...
    app.patch(
      ...
      (request: Request, response: Response) => {
        ...
        this.handlerController<UpdateGroupUsecase, any>(
          container,
          "UpdateGroupUsecase",
          response,
          config,
    ...
    app.patch(
      ...
      (request: Request, response: Response) => {
        ...
        this.handlerController<UpdateTeamsInGroupUsecase, any>(
          container,
          "UpdateTeamsInGroupUsecase",
          response,
          config,
          undefined,
          data
    ...
    app.get(
      `/:tournamentId/fixture-stage/:fixtureStageId/group/:groupId/matches`,
      (request: Request, response: Response) => {
        const params = request.params;
        ...
        this.handlerController<GetGroupMatchesUsecase, any>(
          container,
    ...
    app.delete(
      ...
      (request: Request, response: Response) => {
        ...
        this.handlerController<DeleteFixtureStageUsecase, any>(
          container,
          "DeleteFixtureStageUsecase",
          response,
          config,
          undefined,
          params
    ...
    app.patch(
      ...
      (request: Request, response: Response) => {
        ...
        const config: IMessagesConfiguration = {
          exceptions: {
            NotAllowedStatusModificationError:
              "MODIFY-REGISTERED-TEAM-STATUS:ERROR",
    ...
    app.put(
      ...
      (request: Request, response: Response) => {
        ...
        this.handlerController<EditMatchInsideGroupUsecase, any>(
          container,
          "EditMatchInsideGroupUsecase",
          response,
          config,
          undefined,
          {
    ...
    app.put(
      `/add-teams-into-group`,
      validator("AddTeamsToGroupInsideTournamentUsecase"),
      (request: Request, response: Response) => {
        const params = request.body;
        ...
        const config: IMessagesConfiguration = {
          exceptions: {
            ThereAreTeamRegisteredPreviuslyError:
              "TEAM-IS-ALREADY-IN-THE-GROUP:ERROR",
            TeamAreRegisteredInOtherGroupError:
              "TEAM-IS-ALREADY-IN-OTHER-GROUP:ERROR",
            TeamAreNotRegisteredError:
              "TEAM-ARE-NOT-REGISTERED-IN-TOURNAMENT:ERROR",
          },
          identifier: this.identifier,
          errorCodes: {
    ...
    app.post(
      ...
      (request: Request, response: Response) => {
        ...
        this.handlerController<CreateTournamentUsecase, any>(
          container,
    ...
    app.get(
      `/:id/register-qr`,
      validator("GetRegisterTeamQRUsecase"),
      (request: Request, response: Response) => {
        ...
        this.handlerController<GetRegisterTeamQRUsecase, any>(
          container,
          "GetRegisterTeamQRUsecase",
          response,
          config,
          undefined,
          tournament
    ...
    app.patch(
      `/:id/modify-status`,
      validator("ModifyTournamentStatusUsecase"),
      (request: Request, response: Response) => {
        const body = request.body;
        const data = {
          ...body,
    ...
    app.patch(
      `/:id/modify-locations`,
      validator("ModifyTournamentLocationsUsecase"),
      (request: Request, response: Response) => {
        const body = request.body;
        const data = {
          ...body,
    ...
    app.patch(
      `/:id/modify-referees`,
      validator("ModifyTournamentRefereesUsecase"),
      (request: Request, response: Response) => {
        const body = request.body;
        const data = {
          ...body,
