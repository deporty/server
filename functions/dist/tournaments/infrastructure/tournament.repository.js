                ...
                const mapped = x
                    ...
                    return {
                        match: Object.assign(Object.assign({}, node['match']), { date: (0, helpers_1.getDateFromSeconds)(node['match']['date']), 'team-a': await this.dataSource
                                ...
                                .toPromise(), 'team-b': await this.dataSource
        ...
        return (0, rxjs_1.from)(this.firestore
            ...
            if (x) {
                ...
                const mapped = x.map((node) => {
                    ...
                    return (0, rxjs_1.zip)($teamA, $teamB, (0, rxjs_1.of)(node)).pipe((0, operators_1.map)((j) => {
                        const node = j[2];
                        return Object.assign(Object.assign({}, node), { match: Object.assign(Object.assign({}, node['match']), { 'team-a': j[0], 'team-b': j[1] }) });
                    }));
                });
                return mapped.length > 0 ? (0, rxjs_1.zip)(...mapped) : (0, rxjs_1.of)([]);
            }
