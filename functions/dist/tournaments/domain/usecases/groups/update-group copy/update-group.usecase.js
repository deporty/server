...
class UpdateGroupUsecase extends usecase_1.Usecase {
    ...
    call(param) {
        ...
        if (!param.group.label) {
            return (0, rxjs_1.throwError)(new tournaments_exceptions_1.LabelMustBeProvided());
        }
        if (!param.group.order) {
            return (0, rxjs_1.throwError)(new tournaments_exceptions_1.OrderMustBeProvided());
        }
        console.log(params, 454664);
