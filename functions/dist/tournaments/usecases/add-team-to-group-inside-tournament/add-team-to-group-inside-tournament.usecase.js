...
class AddTeamToGroupInsideTournamentUsecase extends usecase_1.Usecase {
    ...
    call(param) {
        ...
        return (0, rxjs_1.zip)($team, $tournament).pipe((0, operators_1.catchError)((error) => {
            ...
            if (exists) {
                return (0, rxjs_1.throwError)(new add_team_to_group_inside_tournament_exceptions_1.TeamIsAlreadyInTheGroup(team.name));
            }
            ...
            if (isInAnotherGroup) {
                return (0, rxjs_1.throwError)(new add_team_to_group_inside_tournament_exceptions_1.TeamIsAlreadyInOtherGroup(team.name));
            }
