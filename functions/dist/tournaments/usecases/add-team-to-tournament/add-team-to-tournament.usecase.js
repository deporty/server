...
const add_team_to_tournament_exceptions_1 = require("./add-team-to-tournament.exceptions");
    ...
    call(param) {
        ...
        return (0, rxjs_1.zip)($team, $tournament).pipe((0, operators_1.catchError)((error) => {
            ...
            if (((_a = team.members) === null || _a === void 0 ? void 0 : _a.length) == 0) {
                return (0, rxjs_1.throwError)(new add_team_to_tournament_exceptions_1.TeamDoesNotHaveMembers(team.name));
            }
            ...
            if (!exists) {
                ...
                return (0, rxjs_1.throwError)(new add_team_to_tournament_exceptions_1.TeamWasAlreadyRegistered(team.name));
            }
        }), (0, operators_1.mergeMap)((x) => x));
    }
}
